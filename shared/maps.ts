...
export interface KingZone {x:number;y:number;z:number;radius:number;height:number}
export const SUN_INTENSITIES=[.4,.8,1.2,2.1,2.8] as const;
export interface GameMap {version?:1;id:string;name:string;asset:string;walls:Box[];triangles?:number[][];offsetX?:number;offsetY?:number;offsetZ?:number;rotationY?:number;scale?:number;bounds?:{minX:number;maxX:number;minZ:number;maxZ:number};spawns:Record<Team,Spawn[]>;lights?:MapLight[];skybox?:MapSkybox;sun?:MapSun;kingZone?:KingZone}
...
export const ASSETS={glock:'/assets/weapons/glock.glb',player:'/assets/characters/player.glb',playerB:'/assets/characters/fbi-orange.glb',shot:'/assets/sounds/glock-shot.ogg',hit:'/assets/sounds/hitmarker.mp3',step:'/assets/sounds/footstep.ogg',reload:'/assets/sounds/reload.ogg',empty:'/assets/sounds/empty-clip.mp3'};
