...
export interface GameMap {version?:1;id:string;name:string;asset:string;walls:Box[];triangles?:number[][];offsetY?:number;scale?:number;bounds?:{minX:number;maxX:number;minZ:number;maxZ:number};spawns:Record<Team,Spawn[]>;lights?:MapLight[];skybox?:MapSkybox}
